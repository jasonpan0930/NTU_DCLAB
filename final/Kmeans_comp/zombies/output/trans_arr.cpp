...
// --- 設定參數 ---
const int WIDTH = 102;   // 對應 SystemVerilog 的 ZOMBIE_SIZE_X (也是 MIF 的 DEPTH)
const int HEIGHT = 149;  // 對應 SystemVerilog 的 ZOMBIE_SIZE_Y
...
int main() {
    const std::string input_filename = "zombie_1x.bin";
    const std::string output_filename = "zombie_bounds.mif";
