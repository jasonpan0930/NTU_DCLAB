...
module VGA_Pattern (
	input i_clk,
	input i_rst_n,
	input [9:0] i_h_count,  // Horizontal position (0-639)
	input [9:0] i_v_count,  // Vertical position (0-479)
...
// Grid dimensions (3x3)
parameter GRID_H = H_DISPLAY / 3;  // 213 pixels per grid horizontally
parameter GRID_V = V_DISPLAY / 3;  // 160 pixels per grid vertically
